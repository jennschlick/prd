...
<?php if (have_posts()): ?>
	<?php while (have_posts()): the_post(); ?>
		...
		<!-- .content_header -->
		<div class="about about_subpage about_what content cf">
			...
			<div class="about_pager">
				<div class="about_pager_prev">
					<a href="<?php echo esc_url(get_page_link(313)); ?>">Who We Are</a>
				</div>
				<div class="about_pager_next">
					<a href="<?php echo esc_url(get_page_link(317)); ?>">Why We Do It</a>
				</div>
			</div>
			<!-- .about-pager -->
		</div>
