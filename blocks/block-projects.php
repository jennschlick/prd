...
if ($the_query->have_posts()) { ?>
	<div class="project-grid">
		<?php  while ($the_query->have_posts()) { $the_query->the_post(); ?>
			<div class="project-preview" style="<?php if(has_post_thumbnail()): ?>background-image: url('<?php the_post_thumbnail_url();?>');<?php endif;?>" data-aos="fade-up" data-aos-delay="800">
